...
{
    Q_OBJECT //elle declare les slots et les singaux
public:
...
private:
    ...
    Competitions tmpcopitition;
        QSystemTrayIcon *mSystemTrayIcon; //La classe QSystemTrayIcon fournit une icône pour une application dans la barre d'état système
};
